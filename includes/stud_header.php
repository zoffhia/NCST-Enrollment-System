...
<aside id="logo-sidebar" class="flex flex-col fixed top-0 left-0 z-40 w-64 h-screen pt-20 bg-blue-950 border-r border-gray-700 transition-transform -translate-x-full sm:translate-x-0">
    <div class="h-full overflow-y-auto bg-blue-950 flex flex-col">  
      ...
      ` <div class="flex flex-col items-center py-4 border-b border-gray-700">
            ...
            <h2 class="text-lg font-semibold text-white">Student's Full Name</h2>
            <p class="text-sm text-gray-300">Student ID No.</p>
            <hr>
        </div>
        ...
        <ul class="space-y-2 font-medium mt-4 flex-1">
            ...
            <li>
                <a href="/ncst/student_online_enrollment.php" class="flex items-center justify-start gap-2 text-white p-3 rounded-lg hover:bg-blue-800">
                    <svg class="ml-3" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
            ...
            <li>
                <button id="paymentMenuBtn" class="flex items-center justify-between w-full text-left text-white p-3 rounded-lg hover:bg-blue-800">
                    <span class="flex items-center gap-2">
                        <svg class="ml-3" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 48 48">
                            <path fill="currentColor" fill-rule="evenodd" d="M26 9a2 2 0 1 1-4 0V3a2 2 0 1 1 4 0zm8 2a2 2 0 1 1-4 0V6a2 2 0 1 1 4 0zm-18 2a2 2 0 0 1-2-2V6a2 2 0 1 1 4 0v5a2 2 0 0 1-2 2m8 33.5c-7.463 0-12.67-.189-15.921-.367c-3.188-.174-5.85-2.49-6.174-5.776c-.217-2.2-.405-5.284-.405-9.357s.188-7.157.405-9.357c.324-3.287 2.986-5.602 6.174-5.776c3.25-.178 8.458-.367 15.921-.367s12.67.189 15.921.367c3.188.174 5.85 2.49 6.174 5.776c.217 2.2.405 5.284.405 9.357s-.188 7.157-.405 9.357c-.324 3.287-2.986 5.602-6.174 5.776c-3.25.178-8.458.367-15.921.367m0-26a1.5 1.5 0 0 1 1.5 1.5v1.046q.484.06.945.162c1.083.238 2.177.662 2.995 1.32a1.5 1.5 0 1 1-1.88 2.338c-.33-.266-.937-.547-1.757-.727a7.8 7.8 0 0 0-2.491-.134c-.823.096-1.442.33-1.82.617c-.32.245-.492.537-.492 1.003c0 .358.08.556.157.679c.083.132.227.277.494.43c.6.342 1.47.543 2.663.8l.113.023c1.04.223 2.362.505 3.411 1.105c.577.33 1.136.787 1.546 1.438c.415.661.616 1.427.616 2.275c0 1.472-.666 2.62-1.673 3.388c-.823.628-1.832.977-2.827 1.146V40a1.5 1.5 0 0 1-3 0v-1.046q-.484-.06-.945-.163c-1.083-.237-2.177-.66-2.994-1.318a1.5 1.5 0 0 1 1.879-2.339c.33.266.937.547 1.757.727a7.8 7.8 0 0 0 2.491.134c.823-.096 1.442-.329 1.82-.617c.32-.245.492-.537.492-1.003c0-.358-.08-.556-.157-.679c-.083-.132-.227-.277-.493-.43c-.6-.342-1.47-.544-2.664-.8l-.113-.023c-1.04-.223-2.362-.505-3.41-1.105c-.578-.33-1.137-.787-1.546-1.439c-.415-.66-.617-1.427-.617-2.274c0-1.472.666-2.62 1.673-3.388c.823-.628 1.832-.977 2.827-1.146V22a1.5 1.5 0 0 1 1.5-1.5M35 31a2 2 0 0 1 2-2h1a2 2 0 1 1 0 4h-1a2 2 0 0 1-2-2m-24-2a2 2 0 1 1 0 4h-1a2 2 0 1 1 0-4z" clip-rule="evenodd"/>
                        </svg>
                        <span>Payment</span>
                    </span>
                    <svg id="dropdownArrow" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="transition-transform" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708"/>
                    </svg>
                </button>

                <!-- Dropdown -->
                <ul id="paymentDropdown" class="hidden pl-14 space-y-1">
                    <li>
                        <a href="/ncst/payment_online.php" class="block text-white p-2 rounded-lg hover:bg-blue-700">Online Payment</a>
                    </li>
                    <li>
                        <a href="/ncst/payment_onsite.php" class="block text-white p-2 rounded-lg hover:bg-blue-700">On-site Payment</a>
                    </li>
                </ul>
            </li>

            <script>
            document.getElementById("paymentMenuBtn").addEventListener("click", function () {
